...
CACHE_DIR = Path(os.environ.get("LIGHTASD_CACHE_DIR", "/workspace/project/media/cache/lightasd"))
REPORTS_DIR = Path(os.environ.get("FACE_REPORTS_DIR", "/workspace/project/media/reports"))
